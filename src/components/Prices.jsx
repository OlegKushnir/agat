  ...
  return (
    <div className={app.wrapper}>
      <p className={app.text}>
        Вартість прибування залежить від дат поселення.
        Ціна вказана за номер за ніч при поселенні на період від трьох
        ночей. Вказана максимальна кількість осіб для розташування.
        ...
        Бронювання дійсне після надходження передплати. 
        Для отримання додаткової інформації та фото оберіть (натисніть) бажаний тип номера.
        Клієнтам надається безкоштовна парковка!
      </p>
      <span className={css.textImp}></span>
      <p><span className={css.current}>xxx</span> - актуальна ціна на поточну добу</p>
